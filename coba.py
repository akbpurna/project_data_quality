...
start_date              = '2022-10-15'   #parameter (tanggal yang direload)
...
query = """
    ...
    with data_cek as (
        ...
        where   date = '{date}'
                ...
                and kpi is not null and granularity is not null and node is not null and vendor is not null and "level" is not null and "location" is not null
    ), data_baseline as (
    ...
    from data_baseline bl inner join data_cek cek
